...
var node_fetch_1 = __importDefault(__webpack_require__(/*! node-fetch */ "../../node-fetch/lib/index.mjs"));
...
var s3 = new aws_sdk_1.default.S3(); // PUT;/banner
...
function addBanner(event) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    var connection, id, _a, title, img_src, now_1, ext_1, rows, e_1;
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 2:
          ...
          now_1 = datetime_1.dateTime(new Date());

          if (img_src) {
            ext_1 = img_src.split('.').pop();
            node_fetch_1.default(img_src).then(function (res) {
              ...
              return s3.putObject({
                Bucket: "random-admin-images" || false,
                Key: now_1 + "-" + new Date().getTime() + "." + ext_1,
                Body: buffer
              }).promise();
            });
          }
...
/*!***************************************************************************************************!*\
  !*** /Users/kyun/workspace/playground/random-admin/backend/node_modules/node-fetch/lib/index.mjs ***!
  \***************************************************************************************************/
