...
/******/ 	return __webpack_require__(__webpack_require__.s = "../../../save.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "../../../save.ts":
/*!*********************************************************************!*\
  !*** /Users/kyun/workspace/playground/random-admin/backend/save.ts ***!
  \*********************************************************************/
...
var save = function (event, context, callback) {
  node_fetch_1.default(event.image_url).then(function (response) {
    if (response.ok) {
      return response;
    }
