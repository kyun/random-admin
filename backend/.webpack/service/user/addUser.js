...
/******/ 	return __webpack_require__(__webpack_require__.s = "../../../user/addUser.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "../../../user/addUser.ts":
/*!*****************************************************************************!*\
  !*** /Users/kyun/workspace/playground/random-admin/backend/user/addUser.ts ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var authorizationChecker_1 = __webpack_require__(/*! authorizer/authorizationChecker */ "../../../authorizer/authorizationChecker.ts"); // PUT;/user


function addUser(event) {
  return __awaiter(this, void 0, void 0, function () {
    var connection, org_id, _a, id, password, role, now, encrypted, rows, e_1;
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 2:
          ...
          org_id = event.requestContext.authorizer.claims.org_id;
          _a = JSON.parse(event.body), id = _a.id, password = _a.password, role = _a.role;
          return [4
          /*yield*/
          , authorizationChecker_1.authorizeManager('PUT;/user', event, connection)];
        ...
        case 5:
          e_1 = _b.sent();
          console.log('OCCUR ERROR!!'); // console.log(e);

          return [2
          /*return*/
          , {
            statusCode: 400,
            body: JSON.stringify(__assign({}, e_1))
          }];
